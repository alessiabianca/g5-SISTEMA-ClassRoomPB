...
public class MatriculaChoqueTest {
    ...
    public void devePermitirMatriculaQuandoNaoHouverNenhumChoqueDeHorario() throws Exception {
        ...
        matriculaRepository.salvar(new Matricula(aluno, "ES01", periodo, Matricula.StatusMatricula.CONFIRMADA));
    ...
    public void deveLancarExcecaoQuandoHouverChoqueTotalDeHorarioDoAluno() throws Exception {
        ...
        matriculaRepository.salvar(new Matricula(aluno, "ES01", periodo, Matricula.StatusMatricula.SOLICITADA));
    ...
    public void devePermitirMesmoHorarioSeOsPeriodosLetivosForemDiferentes() throws Exception {
        ...
        // CORREÇÃO: Removido o parâmetro '0' (vagas ocupadas) das turmas para alinhar com o leitor de 6 colunas do arquivo
        ...
        // CORREÇÃO: Utiliza o Enum StatusMatricula.CONFIRMADA
        matriculaRepository.salvar(new Matricula(aluno, "ES01", "2026.1", Matricula.StatusMatricula.CONFIRMADA));
