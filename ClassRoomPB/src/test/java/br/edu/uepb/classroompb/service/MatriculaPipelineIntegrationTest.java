...
public class MatriculaPipelineIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        dRepository.salvar(new Disciplina("ES01", "Engenharia de Software I", 60, 4, new ArrayList<>()));
     ...
     * Valida que ao remover um aluno regular de uma turma lotada, o primeiro estudante 
     * da lista de espera assume a vaga com status CONFIRMADA e o tamanho da fila decrementa.
     */
    @Test
    public void devePromoverPrimeiroSuplenteDaFilaSeAlunoTitularCancelarMatricula() throws Exception {
        ...
        periodoRepository.salvar(new Periodo(periodoCodigo, "INICIADO"));
        turmaRepository.salvar(new Turma(disciplina, "PROF_A", periodoCodigo, 1, 1, "24M12", "Sala_101"));

        // Monta o cenário em disco: Aluno_A ocupa a única vaga física. Aluno_B e Aluno_C ficam na fila de espera
        matriculaRepository.salvar(new Matricula("ALUNO_A", disciplina, periodoCodigo, Matricula.StatusMatricula.CONFIRMADA));
        matriculaRepository.salvar(new Matricula("ALUNO_B", disciplina, periodoCodigo, Matricula.StatusMatricula.ESPERA));
        matriculaRepository.salvar(new Matricula("ALUNO_C", disciplina, periodoCodigo, Matricula.StatusMatricula.ESPERA));
        ...
        // VERIFICAÇÃO: Aluno_B (primeiro da fila FIFO) deve ter sido promovido automaticamente para CONFIRMADA
