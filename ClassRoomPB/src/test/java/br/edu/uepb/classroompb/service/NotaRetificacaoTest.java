...
/**
 * US35 — Testes Unitários de Restrição de Alteração de Notas Após Encerramento do Semestre.
 * Segue o mesmo padrão adotado pelo NotaServiceTest (repositórios reais, @Before com limpeza de arquivos).
 */
public class NotaRetificacaoTest {
    ...
    /**
     * Garante que o professor responsável consiga retificar uma nota já lançada
     * quando o período letivo ainda estiver com status INICIADO.
     */
    @Test
    ...
    /**
     * Garante o bloqueio absoluto de retificação de notas quando o período letivo
     * estiver com status ENCERRADO, estourando ValidacaoException.
     */
    @Test
    ...
    /**
     * Garante que um professor NÃO associado à turma seja bloqueado de retificar
     * notas dos alunos vinculados a outro docente.
     */
    @Test
    ...
    /**
     * Garante que a retificação falhe com ValidacaoException quando não houver
     * nota previamente lançada para o aluno na disciplina/período informados.
     */
    @Test
    ...
    /**
     * Garante que notas com valores fora do intervalo estrito [0.0, 10.0]
     * sejam rejeitadas mesmo durante uma retificação legítima.
     */
    @Test
