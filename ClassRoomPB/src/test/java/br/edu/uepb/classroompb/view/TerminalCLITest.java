...
public class TerminalCLITest {
  ...
  public void setUp() {
    ...
    try {
      escreverNoArquivo(
          "data/diarios.txt", "DIARIO1;D01;P01;Diario de D01;MAT2;08:00;S01;60;ABERTO");
  ...
  public void testAdmin() {
    try {
      AutenticacaoService.getInstancia()
          .cadastrarUsuario("administrador", "Admin Silva", "444", "admin@test.com", "senha", null);
    } catch (Exception e) {
    }
  ...
  public void testCoordenador() {
    try {
      AutenticacaoService.getInstancia()
          .cadastrarUsuario("coordenador", "Coord Silva", "333", "coord@test.com", "senha", "C01");
    } catch (Exception e) {
    }
  ...
  public void testProfessor() {
    try {
      AutenticacaoService.getInstancia()
          .cadastrarUsuario("professor", "Prof Silva", "222", "prof@test.com", "senha", null);
    } catch (Exception e) {
    }
  ...
  public void testAluno() {
    try {
      AutenticacaoService.getInstancia()
          .cadastrarUsuario("aluno", "Aluno Silva", "111", "aluno@test.com", "senha", "C01");
    } catch (Exception e) {
    }
  ...
  public void testPerfilDesconhecido() {
    try {
      AutenticacaoService.getInstancia()
          .cadastrarUsuario("misterio", "Misterio", "M999", "misterio@test.com", "senha", null);
    } catch (Exception e) {
    }
