...
public class UsuarioFactoryTest {
    ...
    public void testCriarUsuarioValido() throws Exception {
        Usuario aluno = UsuarioFactory.criarUsuario("aluno", "123", "Nome", "email@test.com", "senha", "C01");
        assertTrue(aluno instanceof Aluno);
        
        Usuario prof = UsuarioFactory.criarUsuario("professor", "123", "Nome", "email@test.com", "senha");
        assertTrue(prof instanceof Professor);
        
        Usuario profUpper = UsuarioFactory.criarUsuario(" PROFESSOR ", "123", "Nome", "email@test.com", "senha");
        assertTrue(profUpper instanceof Professor);
        
        Usuario coord = UsuarioFactory.criarUsuario("coordenador", "123", "Nome", "email@test.com", "senha", "C01");
        assertTrue(coord instanceof Coordenador);
        
        Usuario admin = UsuarioFactory.criarUsuario("administrador", "123", "Nome", "email@test.com", "senha");
