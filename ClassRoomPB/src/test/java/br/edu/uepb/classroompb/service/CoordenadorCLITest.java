...
public class CoordenadorCLITest {
    ...
    public void deveBloquearOfertaDeTurmaQuandoNaoHouverUsuarioLogado() {
        ...
        assertTrue("O sistema deveria ter negado o acesso por falta de credenciais válidas.",
                   resultado.contains("ACESSO NEGADO: Apenas usuarios autenticados com o perfil de Coordenador"));
    }
}