...
public class ProfessorCLITest {
  ...
  public void testLancarEEditarNota() throws Exception {
    ...
    // Need a valid avaliacao created to launch nota properly, assuming AV-1 or something is
    // generated.
    // If not, ValidacaoException will be caught by the catch block inside processar, which is also
    // a good test.
