...
public class AdminCLITest {
    ...
    public void testProcessar() throws Exception {
        ...
        PeriodoService ps = new PeriodoService(pr, new HistoricoService(hr, mr, tr, new SituacaoAcademicaService(nr, new FrequenciaService(tr, mr, fr, nr)), new FrequenciaService(tr, mr, fr, nr)));
