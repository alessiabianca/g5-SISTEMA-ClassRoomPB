...
/**
 * US34 — Repositório de persistência para registros de notas dos alunos.
 * Segue o padrão de arquivo plano CSV já adotado pelo projeto (FrequenciaRepository, MatriculaRepository).
 */
public class NotaRepository {
     ...
     */
    public Nota buscarPorAlunoEDisciplina(String matriculaAluno, String codigoDisciplina, String periodo) {
