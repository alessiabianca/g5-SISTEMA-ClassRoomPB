...
public class UsuarioFactory {
    ...
    /**
     * Padrão Factory: Centraliza e isola a lógica de criação de perfis.
     * Facilita a manutenção e expansão do sistema (Desacoplamento).
     */
    public static Usuario criarUsuario(String tipo, String matricula, String nome, String email, String senha) throws Exception {
        if (tipo == null) {
