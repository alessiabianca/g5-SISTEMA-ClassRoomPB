...
public class CursoService {
    ...
    public void cadastrarCurso(String codigo, String nome, String papelUsuarioLogado) throws ValidacaoException, IOException {
        ...
        // Critério de Aceitação: O sistema deve permitir cadastrar um curso com código e nome (Validação de campos)
        ...
        if (cursoExistente != null) {
            throw new ValidacaoException("Erro: Já existe um curso cadastrado com o código '" + codigo + "'.");
        }
