...
public class Frequencia {
    ...
    public Frequencia(String dataAula, String matriculaAluno, String codigoDisciplina, String periodo, TipoFrequencia status) {
    ...
    public TipoFrequencia getStatus() { return status; }
    public void setStatus(TipoFrequencia status) { this.status = status; }

    @Override
    public String toString() {
        return dataAula + ";" + matriculaAluno + ";" + codigoDisciplina + ";" + periodo + ";" + status.name();
    }
}