...
public class TerminalCLI {
  ...
  private final MatriculaService matriculaService =
      new MatriculaService(turretRepository, matriculaRepository, periodoRepository, disciplinaRepository, historicoRepository);
    ...
    try {
      switch (op) {
        ...
        case "6":
          ...
          coordenadorCLI.processar(
              "gerarRelatorioAlunosMatriculados " + cRelatorio + " " + pRelatorio);
          break;
      ...
      System.err.println(
          "ERRO DE FORMATO: Valores numéricos de carga, créditos ou vagas inválidos.");
    } catch (Exception e) {
